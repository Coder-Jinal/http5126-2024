...
--  5
-- A Provide the total item sales as "Total Sold" (sales), item name (stock_items) generated by all the employees and grouped by the employees. The result should show least sales to most sales. 
-- B
